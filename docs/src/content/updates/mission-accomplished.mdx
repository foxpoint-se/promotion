---
title: Execution day
description: For five-ish years we've been working towards this goal. To do a full trip around Rotholmen below the surface, while being able to celebrate this moment with friends and family.
date: 2025-06-02
image:
  url: /images/rotholmen_execution_day.png
  description: Will our AUV make it around the islet?
---

import { YouTube } from "astro-embed";

<YouTube id="https://youtu.be/Lruz3robOS4" class="max-w-3xl" />
